try:
    ...
    from g29_input import G29
    print("[GT-DriveController] G29 bindings imported successfully")
...
class Controller:
    def __init__(self):
        ...
        self.g29 = G29.auto()
        print("[GT-DriveController] G29 initialized successfully")
    ...
    def update_control(self, binary_data):
        ...
        # Read G29 inputs
        throttle, brake, steering = self.g29.read()
